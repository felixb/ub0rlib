...
public abstract class BitmapWrapper {
	...
	/**
	 * Static singleton instance of {@link BitmapWrapper} holding the SDK-specific implementation of
	 * the class.
	 */
	...
	/**
	 * Create {@link BitmapDrawable} from a {@link Bitmap}, setting initial target density based on
	 ...
	 */
	public abstract BitmapDrawable getBitmapDrawable(final Resources res, final Bitmap bitmap);
}
